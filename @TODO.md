...
- [ ] **Page-by-page Sunnie UI rework** ([owner idea](FEATURE_IDEAS.md#ideas-were-fleshing-out)). Today, Upcoming, Tasks, Calendar, Settings → Calendar accounts, Friends, Focus, and Review are in place. Review now keeps the week on one readable page, hides empty calendar and unfinished-task sections, distinguishes draft from finish, links into Upcoming, and rolls back failed task choices with a clear message. Signed-in desktop and phone QA covered saved and finished reviews, week navigation, empty accounts, task decisions, and Mood Garden. Next page: the remaining Settings sections (Personal, Planning, and Notifications & data). Also verify Calendar reminder, private-name, and connection resync with live Google/CalDAV providers and review a dense imported calendar.
